 ...
 *      @property 
 */
function monitorQueue(serverName, appVersion, capacityProfileConfig, options = {}) {
 ...
 * @param {TenantProcess} process
 * @returns {Promise<TenantProcess} which is the process updated with its completion status
 */
